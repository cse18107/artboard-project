...
const Text = ({
  ...
  <div className='flex flex-col gap-3 border-b border-[#76ABAE] px-5 py-3'>
...
const RenderSelect = ({
  ...
  >
    <SelectTrigger className='no-ring w-full rounded-sm border border-[#76ABAE]'>
      <SelectValue
        placeholder={
          config.property === "fontFamily"
            ? "Choose a font"
    ...
    <SelectContent className='border-[#76ABAE] bg-[#31363F] text-primary-grey-300'>
